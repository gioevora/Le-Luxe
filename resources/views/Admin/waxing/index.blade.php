                                ...
                                <table id="dataTable" class="row-border" style="width:100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Female Price</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Male Price</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $waxs->title }}</td>
                                            <td>{{ $waxs->female_price }}</td>
                                            <td>{{ $waxs->male_price }}</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addServiceForm" action="{{ route('waxing.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="female_price" class="form-label">Female Price</label>
                        <input type="number" class="form-control" id="female_price" name="female_price" required>
                    </div>
                    <div class="mb-3">
                        <label for="male_price" class="form-label">Male Price</label>
                        <input type="number" class="form-control" id="male_price" name="male_price" required>
                    </div>
