                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center" style="background-color: #202A54;">
                                <h6 class="text-white text-capitalize ps-3 m-0">List of Inquiries</h6>
                                ...
                                <table id="dataTable" class="row-border" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $contact->email }}</td>
                                            <td style="max-width: 150px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $contact->message }}</td>

                                            <td>{{ $contact->status }}</td>
                                            <td class="align-middle" style="display: flex; align-items: center; justify-content: center;">
                                                <!-- Approve Button -->
                                                <form action="{{ route('contacts.accept', ['id' => $contact->id]) }}" method="POST" style="display: inline;">
                                                    @csrf
