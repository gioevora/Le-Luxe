                                ...
                                <table class="table" id="myDataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 107px;" aria-label="Role: activate to sort column ascending">Contact#</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 67px;" aria-label="Plan: activate to sort column ascending">Date</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 67px;" aria-label="Plan: activate to sort column ascending">Time</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 67px;" aria-label="Plan: activate to sort column ascending">Pax</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 67px;" aria-label="Plan: activate to sort column ascending">Services</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="even">
                                            <td></td>
                                            <td><span class="text-truncate d-flex align-items-center">{{$sched['lname']}}, {{$sched['fname']}}</span></td>
                                            ...
                                            <td class="">
                                                <div class="d-inline-block text-nowrap">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end m-0">
                                                        <a href="{{ route('appointment.show', ['id' => $sched['id']]) }}" class="dropdown-item">View</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
