                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <div class="row pt-4 px-4 py-4">
                                <div class="col-md-6">
                                    <h4 class="card-title">FACIAL SERVICES LIST</h4>
                                </div>
                                <div class="col-md-6">
                                    <div class="dt-buttons btn-group d-flex justify-content-end gap-2 ">
                                        ...
                                        <div class="dropdown">
                                            <a href="#backDropModal" type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#backDropModal">
                                                <i class='bx bx-plus-circle'></i> Add Facial
                                            </a>
                    ...
                    <div class="modal-dialog">
                        <form class="modal-content" action="{{ route('services.store') }}" method="POST">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="backDropModalTitle">Add New Facial Services</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col mb-0">
                                        <label for="dob" class="form-label">inclusions</label>
                                        <input type="text" id="dob" class="form-control" placeholder="Wax" />
                                    </div>
                                </div>
                            </div>
