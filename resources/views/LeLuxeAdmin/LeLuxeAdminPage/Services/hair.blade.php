                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <div class="row pt-4 px-4 py-4">
                                <div class="col-md-6">
                                    <h4 class="card-title">HAIR SERVICES LIST</h4>
                                </div>
                                <div class="col-md-6">
                ...
                <!-- / Content -->
                  ...
                  <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
                    <div class="modal-dialog">
                        <form class="modal-content" action="{{ route('hairs.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col mb-0">
                                        <label for="email" class="form-label">Inclusions</label>
                                        <input type="text" name="" class="form-control" placeholder="Brazillian" />
                                    </div>
